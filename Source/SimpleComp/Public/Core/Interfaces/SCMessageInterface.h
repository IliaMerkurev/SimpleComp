...
USTRUCT(BlueprintType)
    struct FSCMessagePayload
    {
        ...
        /** Optional reference to the Actor who sent the message (usually the Spawner
         * or its Owner). */
        UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SimpleComp|Message")
    ...
    UINTERFACE(MinimalAPI, BlueprintType)
        ...
        /**
         * ISCMessageInterface: A stable and extensible way for components to talk to
         * each other.
         */
        ...
        public:
             ...
             * Call via ISCMessageInterface::Execute_OnReceiveSCMessage(Target, Payload)
             * in C++.
             */
            UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "SimpleComp|Message")
