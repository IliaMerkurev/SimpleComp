...
UCLASS(ClassGroup = (SimpleComp), meta = (BlueprintSpawnableComponent, DisplayName = "Simple Rotation Component"))
    ...
    protected:
        ...
        UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SimpleComp|Constant",
            meta = (EditCondition = "RotationMode == ESCRotationMode::Constant", EditConditionHides,
                ForceUnits = "deg/s"),
            Interp)
         ...
         * mode. */
        UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SimpleComp|Forward Delta", Interp,
            meta = (EditCondition = "RotationMode == ESCRotationMode::ToForwardDelta", EditConditionHides,
                ForceUnits = "cm"))
        ...
        UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "SimpleComp|Velocity",
            meta = (EditCondition = "RotationMode == ESCRotationMode::ToVelocity", EditConditionHides), Interp)
