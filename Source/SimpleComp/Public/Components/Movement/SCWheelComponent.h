...
/**
 * USCWheelComponent
 * Procedural wheel component that handles rotation and steering based on
 * movement delta.
 */
UCLASS(ClassGroup = (SimpleComp), meta = (BlueprintSpawnableComponent, DisplayName = "Simple Wheel Component"))
